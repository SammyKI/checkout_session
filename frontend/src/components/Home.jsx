...
const Home = () => {
  ...
  const itemName = "INVESTMENTS BITCOIN"
  const itemPrice = 100
        ...
        mx-auto w-full my-16 border-2 bg-[#fcf6f6] border-slate-100 shadow-md py-4'>
           ...
           <div className='flex flex-col lg:w-6/12 w-full py-8'>
             ...
             <div className='text-3xl font-semibold my-6 text-slate-600'>
                price:&nbsp;&nbsp;Kshs.{itemPrice}
             </div>

             <small className='mt-10 mb-3 font-semibold'>Add Your multiplication Factor </small>
             ...
             <span className='text-green-500 text-3xl font-bold pl-3'>Kshs.{finalAmount}</span></div>
             <div className='my-6'>
